        ...
        <div className="user-left-side">
                    {isOwner ? <div>
                        <div ref={notificationRef}>
                            {notifications.length !== 0 ? <div>{!notifications[notifications.length - 1].checked ? <div style={{padding: '5px', backgroundColor: 'red', borderRadius: '15px', marginBottom: '-30px', zIndex: '10', color: 'white'}}><p>Новые</p></div> : <></>}</div> : <></>}
