        ...
        <div className="user-left-side">
                    {isOwner ? <div>
                        <div ref={notificationRef}>
                            {notifications.length !== 0 ? <div>{!notifications[notifications.length - 1].checked ? <div style={{width: '10px', height: '10px', backgroundColor: 'red', borderRadius: '50%', marginBottom: '-30px'}}></div> : <></>}</div> : <></>}
